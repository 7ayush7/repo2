...
public class StreamsExample {
	...
	public static void main(String[] args) {
		...
		List<Student> list3 = Arrays.asList(new Student(1, "test1"), new Student(2, "test2"), new Student(3, "test3"),
				new Student(4, "test4"), new Student(4, "test4"));
		...
		list6.stream().distinct().filter(s -> s > 3).map(a -> a).collect(Collectors.toList())
