...
public class ArrayListExample {
	...
	public static void main(String[] args){
		...
		//but if there is data manipulation then it becomes slow as various shifting operations occur internally for 
		//even one new element that gets added into the list. Hence for that there is LinkedList
		...
		//just that by using list iterator we get freedom to work in both directions (hasPrevious() and hasNext() methods)
		...
		list3.remove(0);//This is tricky as in both remove() methods one takes param as int other as object
		//So this way it will remove not element 0 but element as 0 index, So to delete "0" we need to pass param as
